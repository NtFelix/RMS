-- ============================================================================
-- BETRIEBSKOSTEN PERFORMANCE OPTIMIZATION DATABASE FUNCTIONS
-- ============================================================================
-- 
-- This script creates optimized database functions to improve betriebskosten
-- page performance by moving computation from Cloudflare Workers to the database.
--
-- INSTRUCTIONS:
...
--
-- FUNCTIONS CREATED:
-- - get_nebenkosten_with_metrics: Optimized nebenkosten list with house metrics
...
-- ============================================================================
-- Run these queries after applying the functions to verify they were created:
...
-- Test get_nebenkosten_with_metrics (replace with your user ID)
-- SELECT * FROM get_nebenkosten_with_metrics('your-user-id-here') LIMIT 5;

-- ============================================================================
-- SUCCESS MESSAGE
-- ============================================================================
-- If you see this message, the functions were created successfully!
-- You can now restart your Next.js application to use the optimized functions.
-- ============================================================================