...
const MockAIAssistantInterface = ({ isOpen, onClose }: any) => {
  ...
  return (
    <div role="dialog" aria-labelledby="ai-assistant-title" aria-describedby="ai-assistant-description" aria-modal="true">
      <h2 id="ai-assistant-title">Mietfluss AI Assistent</h2>
      <p id="ai-assistant-description">Fragen Sie mich alles über Mietfluss</p>
      <div>Willkommen beim Mietfluss AI Assistenten</div>
      <div>Stellen Sie mir Fragen über Mietfluss-Funktionen</div>
      <input placeholder="Stellen Sie eine Frage über Mietfluss..." />
