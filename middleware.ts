...
export async function middleware(request: NextRequest) {
  ...
  const csp = [
    ...
    "img-src 'self' data: http://127.0.0.1:54321 http://localhost:54321 https://*.supabase.co https://*.stripe.com https://*.posthog.com",
    "connect-src 'self' http://127.0.0.1:54321 http://localhost:54321 https://*.supabase.co https://*.stripe.com https://api.stripe.com https://*.posthog.com https://backend.mietevo.de",
