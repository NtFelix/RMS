-- Cleanup legacy wasserzaehler functions and unify naming
...
-- 2. Update get_abrechnung_modal_data to use generic names for return columns
...
BEGIN
  ...
  SELECT 
    ...
    (SELECT data FROM relevant_meters) as zaehler,
    (SELECT data FROM relevant_readings) as zaehler_ablesungen;
END;
$function$;
