...
import { Package, Phone, CheckCircle2, ArrowLeft } from 'lucide-react';
...
function WaitlistContent() {
  ...
  const productInfo = {
    browser: {
      ...
      icon: Package,
      description: 'Verwalten Sie Ihre Immobilien direkt aus Ihrem Browser heraus.',
      features: [
    ...
    mobile: {
      title: 'Mobile App',
      icon: Phone,
      description: 'Verwalten Sie Ihre Immobilien unterwegs mit unserer mobilen App.',
      features: [
  ...
  const currentProduct = product === 'browser' || product === 'mobile' 
    ? productInfo[product] 
    : productInfo.browser;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: 'Wir werden Sie benachrichtigen, sobald das Produkt verfügbar ist.',
    });
  };
      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-muted/20 flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <p className="text-muted-foreground">
            Sie wurden erfolgreich zur Warteliste für {currentProduct.title} hinzugefügt.
