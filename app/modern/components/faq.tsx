...
const FAQItem = ({ question, answer, index }: { question: string; answer: string; index: number }) => {
  ...
  return (
    ...
    >
      <motion.div
        className={`p-6 rounded-[2rem] bg-card border border-border/50 shadow-sm cursor-pointer transition-all duration-300 hover:shadow-md ${isOpen ? 'bg-primary/5 border-primary/20' : 'hover:bg-accent/50'}`}
