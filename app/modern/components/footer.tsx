              ...
              <div className="flex gap-4">
                {socialLinks.map((social) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="group size-100 bg-card hover:bg-accent rounded-lg flex items-center justify-center transition-colors border border-border hover:border-white dark:hover:border-primary/50"
