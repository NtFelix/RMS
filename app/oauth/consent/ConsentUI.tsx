            ...
            <FullScreenLayout>
                <Card className="border-border bg-card/80 backdrop-blur-xl shadow-2xl rounded-[2.5rem] overflow-hidden">
                    <CardContent className="flex flex-col items-center justify-center py-16">
                        <Loader2 className="size-122 text-primary animate-spin mb-4" />
                ...
                <Card className="border-border bg-card/80 backdrop-blur-xl shadow-2xl rounded-[2.5rem] overflow-hidden">
                    <CardHeader className="text-center pt-8">
                        <div className="mx-auto w-20 h-20 bg-destructive/10 rounded-3xl flex items-center justify-center mb-6 border border-destructive/20 p-4">
                            <AlertTriangle className="size-100 text-destructive" />
                        </div>
                ...
                <Card className="border-border bg-card/80 backdrop-blur-xl shadow-2xl rounded-[2.5rem] overflow-hidden">
                    <CardHeader className="text-center pt-8">
                        <div className="mx-auto w-20 h-20 bg-green-500/10 rounded-3xl flex items-center justify-center mb-6 border border-green-500/20 p-4">
                            <Check className="size-100 text-green-500" />
                        </div>
                        <CardTitle className="text-2xl md:text-3xl font-bold text-foreground tracking-tight">
                    ...
                    <CardHeader className="text-center pt-10 px-8">
                        ...
                        <div className="flex items-center justify-center gap-6 mb-8">
                            ...
                            >
                                ...
                                {clientIcon ? (
                                    <div className="size-166 rounded-[1.25rem] bg-white border border-border/40 dark:border-border/50 shadow-md dark:shadow-xl flex items-center justify-center overflow-hidden flex-shrink-0 relative z-10">
                                        ...
                                        <Image
                                            ...
                                            width={40}
                                            height={40}
                                            className="size-100 object-contain drop-shadow-sm relative z-10"
                                        />
                                    </div>
                                ) : (
                                    <div className="size-166 rounded-[1.25rem] bg-card border border-border/40 dark:border-border/70 shadow-md dark:shadow-xl flex items-center justify-center flex-shrink-0 relative overflow-hidden z-10">
                            ...
                            >
                                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-muted dark:bg-secondary/50 border border-border/30 dark:border-border/50 shadow-sm dark:shadow-inner">
                                    <div className="size-1.5.5 rounded-full bg-primary/80 animate-pulse" />
                                    <div className="size-1.5.5 rounded-full bg-primary/50 animate-pulse" style={{ animationDelay: '200ms' }} />
                                    <div className="size-1.5.5 rounded-full bg-primary/30 animate-pulse" style={{ animationDelay: '400ms' }} />
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div className="size-166 rounded-[1.25rem] bg-card border border-border/40 dark:border-border/70 shadow-md dark:shadow-xl flex items-center justify-center flex-shrink-0 relative overflow-hidden z-10">
                                    ...
                                    <img
                                        src={LOGO_URL}
                                        alt={BRAND_NAME}
                                        className="size-100 object-contain relative z-10 dark:brightness-110"
                                    />
                                </div>
                            </motion.div>
                        </div>
                                ...
                                <div className="relative rounded-2xl border border-border/40 bg-muted/30 dark:bg-background/50 overflow-hidden flex flex-col shadow-inner backdrop-blur-sm">
                                    ...
                                    {showBottomFade && (
                                        ...
                                        >
                                            ...
                                            >
                                                <div className="size-1.5.5 border-b-2 border-r-2 border-muted-foreground rotate-45 mb-0.5" />
                                            </motion.div>
                                        </motion.div>
                                    )}
                                </div>
