...
import { LandingPageFeatureFlags } from '@/lib/posthog-feature-flags';

interface PricingPageClientProps {
    serverFeatureFlags: LandingPageFeatureFlags;
}
            ...
            <div className="min-h-screen overflow-x-hidden pt-20">
                <div id="pricing">
                    <Pricing
                        ...
                        serverFeatureFlags={{
                            showPricingPreviewLimitNotice: serverFeatureFlags.showPricingPreviewLimitNotice,
                            showWaitlistButton: serverFeatureFlags.showWaitlistButton,
                        }}
                    />
                </div>
