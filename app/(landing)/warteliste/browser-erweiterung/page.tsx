...
import { Package, CheckCircle2, ArrowLeft, Chrome, Globe } from 'lucide-react';
import Link from 'next/link';
import { useToast } from '@/hooks/use-toast';

export default function BrowserExtensionWaitlistPage() {
  ...
  const features = [
    ...
    'Nahtlose Integration mit der Web-App',
    'Unterstützung für Chrome, Firefox und Edge',
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: 'Wir werden Sie benachrichtigen, sobald die Browser-Erweiterung verfügbar ist.',
    });
  };
      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-muted/20 flex items-center justify-center p-6 pt-24 md:pt-16">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <p className="text-muted-foreground">
            Sie wurden erfolgreich zur Warteliste für die Browser-Erweiterung hinzugefügt.
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-4xl font-bold">Browser-Erweiterung</h1>
                  <p className="text-muted-foreground">Demnächst verfügbar</p>
                </div>
              </div>

              <p className="text-lg text-muted-foreground">
                Verwalten Sie Ihre Immobilien direkt aus Ihrem Browser heraus mit unserer leistungsstarken Browser-Erweiterung.
              </p>
              ...
              <div className="flex items-center space-x-4 pt-4">
                <p className="text-sm text-muted-foreground">Unterstützte Browser:</p>
