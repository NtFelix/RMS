    ...
    <div className="flex flex-col gap-8 p-8 bg-white dark:bg-[#181818]">
      ...
      <div className="grid gap-4 grid-cols-1 auto-rows-auto md:grid-cols-6 md:auto-rows-[140px]">
        ...
        <Link href="/haeuser" className="col-span-1 row-span-1 md:col-span-1 md:row-span-1">
          <Card className="min-h-[120px] h-full overflow-hidden bg-zinc-50 dark:bg-[#22272e] border border-gray-200 dark:border-[#3C4251] shadow-sm rounded-3xl hover:shadow-lg transition-all cursor-pointer flex flex-col">
        ...
        <div className="hidden md:block md:col-span-2 md:row-span-3">
          <div className="h-full flex flex-col gap-4">
            <Link href="/todos" className="flex-1">
              <Card className="h-full overflow-hidden bg-zinc-50 dark:bg-[#22272e] border border-gray-200 dark:border-[#3C4251] shadow-sm rounded-3xl hover:shadow-lg transition-all cursor-pointer flex flex-col">
                <CardHeader className="flex flex-row items-center justify-between gap-y-0 pb-2 flex-shrink-0">
                  <CardTitle className="text-sm font-medium">Aufgaben</CardTitle>
                  <div className="p-2 bg-muted rounded-lg">
                    <CheckSquare className="size-4 text-muted-foreground" />
