...
const KautionModal = dynamic(() => import('@/components/modals/kaution-modal').then(mod => mod.KautionModal), { ssr: false })
...
const FileUploadModal = dynamic(() => import('@/components/modals/file-upload-modal').then(mod => mod.FileUploadModal), { ssr: false })
const FileRenameModal = dynamic(() => import('@/components/modals/file-rename-modal').then(mod => mod.FileRenameModal), { ssr: false })
const CreateFolderModal = dynamic(() => import('@/components/modals/create-folder-modal').then(mod => mod.CreateFolderModal), { ssr: false })
const CreateFileModal = dynamic(() => import('@/components/modals/create-file-modal').then(mod => mod.CreateFileModal), { ssr: false })
const FolderDeleteConfirmationModal = dynamic(() => import('@/components/modals/folder-delete-confirmation-modal').then(mod => mod.FolderDeleteConfirmationModal), { ssr: false })
const FileMoveModal = dynamic(() => import('@/components/modals/file-move-modal').then(mod => mod.FileMoveModal), { ssr: false })
const ShareDocumentModal = dynamic(() => import('@/components/modals/share-document-modal').then(mod => mod.ShareDocumentModal), { ssr: false })
const MarkdownEditorModal = dynamic(() => import('@/components/modals/markdown-editor-modal').then(mod => mod.MarkdownEditorModal), { ssr: false })
