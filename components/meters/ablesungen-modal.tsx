              ...
              {isLoading ? (
                ...
                <Card className="bg-gray-50 dark:bg-[#22272e] border border-dashed border-gray-300 dark:border-gray-600 rounded-3xl">
                  <CardContent className="flex flex-col items-center justify-center p-8 text-center">
                    <Gauge className="size-122 text-muted-foreground/50 mb-3" />
                              ...
                              >
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                    <div className={cn("size-100 rounded-full flex items-center justify-center", getMeterBgColor(ablesungenModalData?.zaehlerTyp))}>
