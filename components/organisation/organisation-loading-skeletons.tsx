...
export function MemberPermissionsSkeleton() {
  return (
    <div className="space-y-6" aria-busy="true" aria-label="Berechtigungen werden geladen">
      ...
      <DetailCardSkeleton title="Hauszugriff" description="Objektzugriffe werden geladen." rows={4} />
      <DetailCardSkeleton title="Modulrechte" description="Modulrechte werden geladen." rows={5} />
    </div>
  );
}
