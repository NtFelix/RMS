      ...
      >
        ...
        {!hideCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute right-3 top-3 rounded-full p-2 opacity-70 ring-offset-background transition-all duration-300 hover:opacity-100 hover:bg-gray-100 hover:scale-[1.01] active:scale-[0.99] hover:shadow-lg hover:rotate-90 dark:modal-close-hover focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground sm:right-4 sm:top-4 sm:p-2.5 md:right-6 md:top-6"
          >
            <X className="h-4 w-4" />
