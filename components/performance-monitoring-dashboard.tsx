...
export function PerformanceMonitoringDashboard({ 
  ...
  const getPerformanceColor = (executionTime: number): string => {
    if (executionTime < PERFORMANCE_THRESHOLDS.FAST) return COLORS.fast;
    if (executionTime < PERFORMANCE_THRESHOLDS.ACCEPTABLE) return COLORS.acceptable;
    if (executionTime < PERFORMANCE_THRESHOLDS.SLOW) return COLORS.slow;
