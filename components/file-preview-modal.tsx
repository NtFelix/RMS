  ...
  return (
    <Dialog open={isFilePreviewModalOpen} onOpenChange={() => closeFilePreviewModal()}>
      ...
      >
        ...
        {/* Content */}
        <div className="flex-1 overflow-hidden bg-muted/10 rounded-b-lg">
          {isLoading && (
          ...
          {fileUrl && !isLoading && !error && (
            <>
              ...
              {isPdf && (
                <div className="h-full p-6 rounded-b-lg">
                  <div className="h-full bg-white rounded-lg shadow-2xl border border-border/20 overflow-hidden">
                    <iframe
                      src={`${fileUrl}#toolbar=1&navpanes=1&scrollbar=1&view=FitH&zoom=page-fit`}
                      className="w-full h-full border-0 rounded-lg"
                      title={filePreviewData.name}
