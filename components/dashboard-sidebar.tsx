              ...
              {sidebarNavItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    onClick={() => setIsOpen(false)}
                    className={cn(
                      "group flex items-center gap-3 rounded-lg px-3 py-2 mr-2 text-sm font-medium transition-all duration-500 ease-&lsqb;cubic-bezier(0.4,0,0.2,1)&rsqb; hover:bg-accent hover:text-white hover:ml-2 hover:mr-0 hover:shadow-lg hover:shadow-accent/20",
                  ...
                  >
                    <item.icon className="h-4 w-4 transition-all duration-500 ease-&lsqb;cubic-bezier(0.4,0,0.2,1)&rsqb; group-hover:scale-125 group-hover:rotate-3" />
                    <span className="transition-all duration-500 ease-&lsqb;cubic-bezier(0.4,0,0.2,1)&rsqb; group-hover:font-semibold group-hover:tracking-wide">
                      {item.title}
                    </span>
                  </Link>
                )
