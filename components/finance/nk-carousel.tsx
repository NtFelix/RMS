...
const features = [
  {
    ...
    longText: 'Soll/Ist-Abgleich pro Mietverhältnis. Automatische Vorschläge für angepasste Vorauszahlungen bei großen Abweichungen.',
    color: "violet",
    ring: 1,
    angle: 270,
    offset: 30,
  ...
  },
  {
    ...
    longText: 'Definieren Sie individuelle Abrechnungszeiträume je Haus.',
    color: "emerald",
    ring: 2,
    angle: 340,
    offset: -20,
