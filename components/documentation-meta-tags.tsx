...
export function DocumentationMetaTags({ 
  ...
  let canonicalUrl = `${process.env.NEXT_PUBLIC_SITE_URL || 'https://mietfluss.de'}/documentation`;
  ...
  if (article) {
    ...
    canonicalUrl = `${process.env.NEXT_PUBLIC_SITE_URL || 'https://mietfluss.de'}/documentation/${article.id}`;
  } else if (searchQuery) {
    ...
    canonicalUrl = `${process.env.NEXT_PUBLIC_SITE_URL || 'https://mietfluss.de'}/documentation?search=${encodeURIComponent(searchQuery)}`;
  } else if (category) {
    title = `${category} | Mietfluss Dokumentation`;
    description = `Alle Artikel in der Kategorie "${category}" der Mietfluss Dokumentation.`;
    canonicalUrl = `${process.env.NEXT_PUBLIC_SITE_URL || 'https://mietfluss.de'}/documentation?category=${encodeURIComponent(category)}`;
  }
