...
export function SummaryCard({
  ...
  return (
    <CardWrapper>
      <Card
        className={cn(
          // Basis-Styles (Feature)
          "relative overflow-hidden rounded-xl shadow-md transition-all duration-200 hover:shadow-lg",
          // Wenn du in main bewusst eine sichtbare Border hast, ersetze border-none durch border
          // "border",
          "border-none",
          // Optional: übernimm die globale Klasse aus main, falls dein Dashboard-Layout darauf aufbaut
          // "summary-card",
          onClick && "cursor-pointer hover:scale-[1.02]",
        // Ermöglicht weitere externe Klassen-Overrides
          className
        )}
        onClick={onClick}
      >
  ...
  return (
    <Card
      className={cn(
        ...
        // Konsistentes Border-Verhalten wie oben
        // "border",
        "border-none",
        className
      )}
